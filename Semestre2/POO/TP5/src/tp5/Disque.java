...
public class Disque extends ObjetPlan {
   ...
   public Disque(String nom){
       super(nom);
       this.centre = new Point("p"+nom); //pour initialiser un attribut qui vient dune autre classe on doit creer une nouvelle instance(sans le constructeur par defaut de lautre classe ca ne marche pas)
       this.rayon = 1;
   }
   ...
   //QUESTION 3
    ...
    public String toString(){
        return super.toString() +""+" : " +"("+ this.centre + ")" +","+ this.rayon + ")" +
