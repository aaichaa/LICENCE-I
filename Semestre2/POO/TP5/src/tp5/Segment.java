...
public class Segment extends ObjetGeom{
    ...
    public Segment(Point ext1, Point ext2,String nom) {
        super(nom);
     ...
     // public Segment(Segment autre,String n){
       //   this()
    ...
    public Segment(String nom){
        super(nom);
        this.ext1 = new Point("p"+nom);//on cree une nouvellle instance pour linitialisation (ca ne marche pas si la classe point n'a pas de constructeur standard)
        this.ext2 = new Point("p"+nom);
    }
