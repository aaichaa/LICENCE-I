...
public class Triangle extends ObjetPlan
{
    ...
    {
        return new Segment(this.getA(),this.getB(),getA().getNom()+"-"+getB().getNom());
    }

    public Segment getAC()
    {
        return new Segment(this.getA(),this.getC(),getA().getNom()+"-"+getC().getNom());
    }

    public Segment getBC()
    {
        return new Segment(this.getB(),this.getC(),getB().getNom()+"-"+getC().getNom());
    }
    ...
    public boolean equals(Triangle autre)
    {
        ...
        return 
                isEqualStrict(autre)||
                isEqualStrict(new Triangle(autre.getAC(),autre.getB(),"fff"))||
                isEqualStrict(new Triangle(autre.getAB(),autre.getC(),"fff"));
    }
}
